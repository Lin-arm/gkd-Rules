  ...
  groups: [
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          // preKeys: [1],
          matches: [
            '[text^="明日签到"] <<3 * - * < * - * > Image[width=77][height=77][visibleToUser=true]',
          ],
          fastQuery: false,
    ...
    },
    {
      ...
      rules: [
        {
          matches: [
            'EditText[vid="editor"] +2 [text="搜索"][vid="right_button"]',
          ],
          fastQuery: true,
    ...
    },
    {
      ...
      rules: [
        {
          matches: [
            'LinearLayout[vid="button_layout"] > Button[text="允许"][vid="confirm_btn"][visibleToUser=true]',
          ],
          fastQuery: true,
          snapshotUrls: [
